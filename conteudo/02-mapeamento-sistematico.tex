...
O capítulo anterior estabeleceu o vocabulário necessário para tratar de escalonamento em lote
e de pegadas ambientais em computação. Este capítulo se propõe a examinar o que a literatura efetivamente produziu
quanto impactos ambientais em HPC, e o faz por meio de um mapeamento sistemático de literatura.

O objetivo deste capítulo não é apenas apresentar que existem lacunas na literatura. Dada a recência da área,
com pouco mais de uma década de acumulação de conhecimento, isso é o esperado. O capítulo tem como objetivo
sustentar é que essas lacunas não estão distribuídas aleatoriamente. Na verdade, os pontos cegos da literatura
acompanham a fronteira da instrumentação disponível, e não a fronteira da pegada ambiental dos sistemas de HPC.
Em larga medida, o que se deixou de estudar são os impactos para os quais ainda não existem inventários, sinais
e métricas. A partir disso, entende-se que a célula do mapa de conhecimento que essa dissertação ocupa não está
vazia por falta de interesse científico, mas sim por carência de instrumentação. Como se argumenta na Seção 3.5,
é essa carência que determina uma das contribuições deste trabalho, além da ordem em que os capítulos seguintes
se apresentam.

O capítulo está organizado em cinco seções. A Seção 3.1 descreve o protocolo de mapeamento sistemático e sua
execução, enquanto a Seção 3.2 apresenta o esquema de classificação em quatro facetas desenvolvido a partir
do corpus de relatos. A distribuição dos relatos por esse esquema é percorrida com detalhes na Seção 3.3, 
que finalizada com a leitura das ausências notáveis. Por fim, a Seção 3.4 discute as limitações do mapeamento
e a Seção 3.5 extrai as implicações para a presente dissertação. 
